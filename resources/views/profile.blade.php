...
<div class="row">
  ...
  <div class="col-sm-10">
    ...
    if(session()->has('systemsession'))
    {
        ...
        $mylogs = DB::table('tbl_logs')->where('username', $profile->usr_name)->orderBy('id', 'desc')->limit(15)->get();
            ...
            if($profilecateg)
            {
              ...
              <div class="main-container">
                <br>
                    ...
                    <a href="#" class="changepassword"><p class="inputlabel">Change Password</p></a>
        ...
        {
            Session()->put('notes', "Error: Invalid account or password");
            echo '<meta http-equiv="refresh" content="0;url=/Login">';
    ...
    {
            Session()->put('notes', "Error: Login First");
            echo '<meta http-equiv="refresh" content="0;url=/Login">';
    }
    ?>
